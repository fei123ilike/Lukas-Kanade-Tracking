...
def LucasKanade(It, It1, rect, p0 = np.zeros(2)):
    ...
    #compute the gradient and the spline in template(It) & current image(It1)
...
#        It_interpolate = It_spline.ev(xx,yy)
#        It1_interpolate = It1_spline.ev(warp_xx,warp_yy)
...
#        Grad_x = Grad_x_spline.ev(warp_xx,warp_yy).ravel().reshape(-1,1)
#        Grad_y = Grad_y_spline.ev(warp_xx,warp_yy).ravel().reshape(-1,1)
